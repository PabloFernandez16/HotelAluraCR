...
public class RegistroHuespedView extends JFrame {
	...
	public static Huesped huespedEditable;
	private Exito mensajeUsuario;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHuespedView frame = new RegistroHuespedView(huespedEditable.getId());
	...
	//constructor para registrar huespedes
	public RegistroHuespedView(int id) {
		this.idReserva = id; //este id viene de la ultima reserva creada en ReservasViews 
   ...
   // int id;
	...
	int idReserva = Integer.parseInt(txtNreserva.getText());
				...
				if(nombre != "" && apellido != "" && fechaNacimiento != null && nacionalidad != null && telefono != "" && idReserva != -1) {
					//String fechaNac = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
					Huesped nuevo = new Huesped(nombre, apellido, fechaNacimiento, 
									nacionalidad, telefono,  idReserva);
					
					huespedController.guardar(nuevo);
