...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		btnSalir.setBounds(754, 447, 85, 21);
		btnSalir.setSize(100, 50);
		btnSalir.setBackground(SystemColor.window);

		btnSalir.setHorizontalAlignment(SwingConstants.CENTER);
		btnSalir.setForeground(SystemColor.textHighlight);
		btnSalir.setFont(new Font("Roboto Light", Font.PLAIN, 20));
		btnSalir.setCursor(new Cursor(Cursor.HAND_CURSOR));
		
		 // Agregar un MouseListener para manejar el evento de clic
