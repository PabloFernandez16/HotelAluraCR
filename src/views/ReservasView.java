...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {
		...
		validaFormReserva(java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS), txtValor.getText(),
				txtFormaPago.getSelectedItem().toString());

		reservaController.guardar(nuevaReserva);

		int idB = reservaController.buscarIdUltimaReserva();

		RegistroHuespedView huesped = new RegistroHuespedView(idB);

		huesped.setVisible(true);
		dispose();
	}

	private void validaFormReserva(Date fechaI, Date fechaF, String Precio, String formaPago) {
