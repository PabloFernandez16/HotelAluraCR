...
public class EditarHuespedView extends JFrame{

		private HuespedController huespedController;
	
		private Huesped huespedEditable;
...
public EditarHuespedView(Huesped huesped) {
		
		this.huespedEditable = huesped;
		...
		txtNombre.setText(this.huespedEditable.getNombre());
		...
		txtApellido.setText(this.huespedEditable.getApellido());
		...
		txtFechaN.setDate(this.huespedEditable.getFechaNacimiento());
		...
		txtNacionalidad.setSelectedItem(this.huespedEditable.getNacionalidad());
		...
		txtTelefono.setText(this.huespedEditable.getTelefono());
		...
		txtNreserva.setText(this.huespedEditable.getIdReserva()+"");
		...
		btnguardar.setBounds(723, 560, 122, 35);
			...
			JLabel labelGuardar = new JLabel("EDITAR");
			labelGuardar.setHorizontalAlignment(SwingConstants.CENTER);
			labelGuardar.setForeground(Color.WHITE);
			labelGuardar.setFont(new Font("Roboto", Font.PLAIN, 18));
			labelGuardar.setBounds(0, 0, 122, 35);
			
			int id1 = huespedEditable.getId();
			...
			btnguardar.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					Huesped huespedEditado = new Huesped(id1, nombre, apellido, fechaNacimiento, nacionalidad, telefono, idReserva);
					
					huespedController.actualizar(huespedEditado);
